...
// LoadLoggerInCtx set a logger into the context to be latter used.
func LoadLoggerInCtx(logger *zap.SugaredLogger) func(*gin.Context) {
...
func Logger(ctx *gin.Context) {
	...
	l.Info(fmt.Sprintf("%s %s %d ip:'%s' [uuid:%s]",
		ctx.Request.Method,
